    ...
    <asp:Panel ID="wholepanel" runat="server" Height="105%">
        <asp:Panel ID="BSPPanels" runat="server" Height="29%">
            <asp:Panel ID="BillingLabelPanel" runat="server" Style="border-width: 2px 2px 2px 2px" Width="100%" Height="25px" BorderStyle="Solid" BorderColor="Black">
              ...
              <asp:Panel ID="BillingAddressPanel" runat="server" Width="100%" Height="55%" Style="padding-bottom:20px" >           
            ...
            <asp:Panel ID="Panel1" runat="server" Style="border-width: 2px 2px 2px 2px" Width="100%" Height="25px" BorderStyle="Solid" BorderColor="Black">
              ...
              <asp:Panel ID="Panel2" runat="server" Width="100%" Height="55%" Style="padding-bottom:20px">           
            ...
            <asp:Panel ID="Panel7" runat="server" Width="100%" Style="padding-bottom: 20px;">           
                    <asp:Label ID="PaymentMethodLabel1" runat="server" Text="Default Payment Method" Width="100%" Font-Size="Medium"></asp:Label>
                       ...
                       <asp:Panel ID="Panel9" runat="server" Style="border-width: 2px 2px 2px 2px" Width="100%" Height="25px" BorderStyle="Solid" BorderColor="Black">
                         ...
                         <asp:GridView ID="GridView1" runat="server" CellPadding="3" GridLines="None" AutoGenerateColumns="false" style="float:left">
                             <Columns>
                                 <asp:BoundField DataField="ItemName" ItemStyle-Width ="300px" HeaderText="Name" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left" HeaderStyle-Font-Size="Medium"></asp:BoundField>
                                 <asp:BoundField DataField="ItemAuthor" ItemStyle-Width ="200px" HeaderText="Author" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Font-Size="Medium" ></asp:BoundField>
                                 <asp:BoundField DataField="ItemISBN" ItemStyle-Width ="200px" HeaderText="ISBN" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Font-Size="Medium"></asp:BoundField>
                                 <asp:BoundField DataField="ItemType" ItemStyle-Width ="100px" HeaderText="Type" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Font-Size="Medium"></asp:BoundField>
                                 <asp:BoundField DataField="ItemQuantity" ItemStyle-Width ="100px" HeaderText="Quantity" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Font-Size="Medium"></asp:BoundField>
                                 <asp:BoundField DataField="ItemUnitPrice" ItemStyle-Width ="150px" HeaderText="Unit Price" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Font-Size="Medium"></asp:BoundField>
